...
// השורה הזו פותרת את שגיאת ה-Build ב-Vercel
export const dynamic = 'force-dynamic';

import { useState, useEffect } from "react";
import { createClient } from "@supabase/supabase-js";

// יצירה בטוחה של הלקוח
    ...
    <div className="min-h-screen bg-[#FDFBF7] p-4 sm:p-8 font-sans" dir="rtl">
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === 'schedule' ? (
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-brand-stone/20 overflow-x-auto">
